  ...
  <v-container class="d-flex justify-center align-center">
    <v-card width="500px">
      ...
      <v-card-text>
        ...
        <v-card-text class="d-flex flex-column align-Right">
          *If a letter appears as yellow in one position but green in another, it means there is at
          least one more of the green letter in the word, but not in the yellow letter's position
        </v-card-text>
        <div
          class="d-flex justify-start bg-secondary text-h6"
          style="padding-left: 5px; padding-right: 5px"
        ...
        <v-card-text class="d-flex flex-column align-Right">
          *If a letter appears as red in one position but green in another, it means that the letter
          only appears once for each green letter
        </v-card-text>
        <div
          class="d-flex justify-start bg-secondary text-h6"
          style="padding-left: 5px; padding-right: 5px"
        ...
        <v-card-text class="d-flex flex-column align-Right">
          In this example, "C" is a correct letter in the correct spot, "R", "U", and "L" are
          misplaced, and "E" is not in the word
        </v-card-text>
      </v-card-text>
    </v-card>
  </v-container>
