...
<template>
  ...
  <v-card>
    ...
    <v-card-text>
      ...
      The end goal of this project is to create a working version of the classic word
      game Wordle using Vue.js and Vuetify. Along with a few other things to make it interesting.
      <br /><br />
      One of our instrustors is Meg, she is a genius sofware engineer at Intellitect. 
      Shadowing her made me realize I wanted to become a developer! <br />
