...
Axios.get(`/Word/GetWordOfDayLastTenDays?userName=${localStorage.name}`) //might be wrong api call, should call Word/GetWordOfDayTenDays, i.e. wordController's GetWordOfDayTenDays method
  .then((response) => {
