      ...
      <v-card>
        <v-layout>
          <v-app-bar app color="#5439AA">
            ...
            <v-app-bar-nav-icon color="#ffffff" @click.stop="drawer = !drawer"></v-app-bar-nav-icon>
          </v-app-bar>

          <v-navigation-drawer app v-model="drawer" temporary location="end">
