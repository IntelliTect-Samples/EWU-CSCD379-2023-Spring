<template>
    ...
    <v-dialog :model-value="show" @update:model-value="show = false" scrollable width="400" height="50%">
        
        <v-card>
            <v-card-title class="d-flex align-center bg-primary">
                Hints
                <v-spacer/>
                <v-btn icon variant="tonal" @click="show = !show" size="small"><v-icon icon="mdi-window-close"/></v-btn>
            </v-card-title>
            <v-card-text>
                <v-row>
