<template>
    <v-toolbar :elevation="4">
        ...
        <v-navigation-drawer app v-model="drawer"  rail rail-width="30px" location="right" temporary>
            <template v-slot:prepend>
                    <v-btn color="purple-accent-2" size="medium" class="ml-4 mt-1" icon="mdi-close-circle-outline" @click="drawer = !drawer"></v-btn>
                    <v-btn color="purple-accent-2" size="medium" class="ml-3 mt-1" icon="mdi-cog-outline" @click="dialog=true"></v-btn>
