...
* Good familiarity with web development
* [CSS](https://developer.mozilla.org/en-US/docs/Web/CSS) (classes, format, concept)
* HTML (basic understanding of how HTML is structured and works)
...
* Object Oriented Programming (classed, interfaces, properties, encapsulation, etc.)
* General database design: tables, queries, keying, etc.
...
* [ASP.NET Core 7.0](https://docs.microsoft.com/en-us/aspnet/core/?view=aspnetcore-7.0)
