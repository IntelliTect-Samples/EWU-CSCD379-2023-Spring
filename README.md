...
## Extra Credit Ideas:
    ...
    - Different word categories: We could have users choose between word categories like animals, fruits, vegetables, vehicles, etc.
    - Live multiplayer: We could have two or more players race against each other to see who guesses the word first.
    - Time limit: We could time the user and the faster they guess the word the more points they get.
