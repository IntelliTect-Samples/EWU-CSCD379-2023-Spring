...
{
    options.AddPolicy(Policies.CanCreateDeleteWords, Policies.CanCreateDeleteWordsPolicy);
});
...
if (string.IsNullOrEmpty(redirectRootUrl)) redirectRootUrl = "https://kind-stone-01ab5711e.3.azurestaticapps.net/";
