...
public static class Seeder
{
    ...
    public static void SeedPlayers(AppDbContext db)
    {
        if (!db.Players.Any())
        {
            db.Players.Add(new Player { Name = "Sam", AverageAttempts = 4.5,
                                        AverageSecondsPerGame = 62, GameCount = 25,
                                        PlayerId = Guid.NewGuid() });
            db.Players.Add(new Player { Name = "James", AverageAttempts = 4.8,
                                        AverageSecondsPerGame = 195, GameCount = 42,
                                        PlayerId = Guid.NewGuid() });
            db.Players.Add(new Player { Name = "Kelly", AverageAttempts = 3.5,
                                        AverageSecondsPerGame = 30, GameCount = 55,
                                        PlayerId = Guid.NewGuid() });
            db.Players.Add(new Player { Name = "Susan", AverageAttempts = 2.7,
