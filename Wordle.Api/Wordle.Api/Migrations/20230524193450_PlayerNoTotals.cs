...
public partial class PlayerNoTotals : Migration
{
    ...
    {
        migrationBuilder.AddColumn<double>(name: "TotalAttempts", table: "Players", type: "float",
                                           nullable: false, defaultValue: 0.0);

        migrationBuilder.AddColumn<int>(name: "TotalSecondsPerGame", table: "Players", type: "int",
