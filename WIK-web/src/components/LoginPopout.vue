    ...
    >
      <v-card width="100%" height="75%">
        ...
        <v-chip-group outlined class="justify-center ma-10 pa-10">
          ...
          <v-text-field :disabled="logout" label="User" v-model="username" variant="outlined"></v-text-field>
          <v-text-field :disabled="logout" label="Password" v-model="password" variant="outlined"></v-text-field>
